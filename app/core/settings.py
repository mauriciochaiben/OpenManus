...
class Settings(BaseSettings):
    ...
    llm_max_input_tokens: Optional[int] = Field(default=None, description="Default max input tokens")
    ...
    browser_chrome_instance_path: Optional[str] = Field(default=None, description="Chrome instance path")
    ...
    browser_proxy_server: Optional[str] = Field(default=None, description="Proxy server")
    browser_proxy_username: Optional[str] = Field(default=None, description="Proxy username")
    browser_proxy_password: Optional[str] = Field(default=None, description="Proxy password")
    ...
    chroma_auth_token: Optional[str] = Field(default=None, description="ChromaDB auth token")
    ...
    embedding_openai_api_key: Optional[str] = Field(default=None, description="OpenAI API key for embeddings")
    ...
    def llm_configs(self) -> Dict[str, LLMSettings]:
        ...
        configs = {
            "default": LLMSettings(**base_settings)
        }
