        ...
        try {
            ...
            if (history.length === 0) {
                ...
                setMessages([{
                    id: '1',
                    role: 'assistant',
                    content: 'Olá! Sou o OpenManus, seu assistente de IA. Posso ajudá-lo a processar documentos, analisar dados e executar tarefas complexas. Como posso ajudá-lo hoje?',
