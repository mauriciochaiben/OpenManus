...
import { Card, Row, Col, Button, Input, Select, Badge, Typography, Space, Divider, Tabs } from 'antd';
import {
    ThunderboltOutlined,
    StarOutlined,
    HeartOutlined,
                    ...
                    <Row gutter={[24, 24]}>
                        ...
                        <Col xs={24} md={12}>
                            <Card title="Inputs" className="openManus-card">
                                <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                                    <Input placeholder="Input normal" className="openManus-input" />
                                    <Input.Password placeholder="Senha" className="openManus-input" />
                ...
                <div style={{ padding: '24px' }}>
                    <Card title="Tipografia" className="openManus-card">
                        <Space direction="vertical" size="large" style={{ width: '100%' }}>
                            ...
                            <div>
                                <Paragraph>
                                    Este é um parágrafo normal demonstrando como o texto fica com o tema customizado do OpenManus.
                                    O tema foi projetado para ser moderno, limpo e acessível.
                                </Paragraph>
                                <Text type="secondary">Texto secundário</Text><br />
                                <Text type="success">Texto de sucesso</Text><br />
                                <Text type="warning">Texto de aviso</Text><br />
                                <Text type="danger">Texto de erro</Text><br />
                                <Text disabled>Texto desabilitado</Text><br />
                                <Text mark>Texto marcado</Text><br />
                                <Text code>Código inline</Text><br />
                                <Text keyboard>Ctrl+C</Text><br />
                                <Text underline>Texto sublinhado</Text><br />
                                <Text delete>Texto deletado</Text><br />
    ...
    return (
        <div className="openManus-fade-in-up" style={{ padding: '24px' }}>
            ...
            <div style={{ marginBottom: '32px', textAlign: 'center' }}>
                ...
                <Paragraph>
                    Explore os componentes com o tema customizado.
                    Teste a troca entre tema claro e escuro usando o botão no header.
                </Paragraph>
