...
describe('DocumentUpload Component', () => {
  ...
  it('renders upload area correctly', () => {
    ...
    expect(
      screen.getByText(/Support for.*files\. Maximum file size: 50MB/)
    ).toBeInTheDocument();
  });
  ...
  it('renders with default props', () => {
    ...
    expect(
      screen.getByText(/You can upload up to 10 files at once/)
    ).toBeInTheDocument();
    expect(
      screen.getByText(/\.pdf, \.doc, \.docx, \.txt, \.md/)
    ).toBeInTheDocument();
  });
  ...
  it('renders with custom props', () => {
    ...
    expect(
      screen.getByText(/You can upload up to 5 files at once/)
    ).toBeInTheDocument();
