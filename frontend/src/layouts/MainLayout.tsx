                        ...
                        <Title level={4} style={{ margin: 0, color: '#262626' }}>
                            {location.pathname === '/' ? 'Home' :
                                location.pathname === '/dashboard' ? 'Dashboard' :
                                    location.pathname === '/chat' ? 'Chat/Agente' :
                                        location.pathname === '/knowledge' ? 'Base de Conhecimento' :
                                            location.pathname === '/workflow' ? 'Workflows' :
                                                location.pathname === '/llm-config' ? 'Configurar LLM' :
                                                    location.pathname === '/mcp-config' ? 'Configurar MCP' :
