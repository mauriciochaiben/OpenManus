 ...
 */
export const searchNotes = async (searchQuery: NoteSearchQuery): Promise<NoteSearchResponse> => {
    try {
        const response = await apiClient.post<NoteSearchResponse>('/search', searchQuery);
        return response.data;
    } catch (error) {
