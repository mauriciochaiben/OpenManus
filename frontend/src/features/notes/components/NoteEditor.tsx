    ...
    return (
        <Card
            title={
                <Space>
                    <EditOutlined />
                    <span>{mode === 'create' ? 'New Note' : mode === 'edit' ? 'Edit Note' : 'View Note'}</span>
                    {note.is_public ? (
                    ...
                    <Col xs={24} sm={12}>
                        <Space>
                            ...
                            <Switch
                                ...
                                onChange={(checked) => setNote(prev => ({ ...prev, is_public: checked }))}
                                disabled={mode === 'view'}
                        ...
                        {mode !== 'view' && (
                            <div style={{ marginTop: '8px' }}>
                                <Input
                                    ...
                                    style={{ width: '200px' }}
                                    addonAfter={
                                        <Button type="text" onClick={addTag} disabled={!newTag.trim()}>
                                            Add
                                        </Button>
                                    }
                                />
                ...
                <div>
                    ...
                    <div style={{ marginTop: '8px' }}>
                        {mode === 'view' ? (
                            <MDEditor.Markdown
                                source={note.content || ''}
                                style={{ padding: '16px', border: '1px solid #d9d9d9', borderRadius: '6px' }}
                            />
                        ) : (
                            <MDEditor
                                value={note.content || ''}
                                onChange={(val) => setNote(prev => ({ ...prev, content: val || '' }))}
                                preview="edit"
                                height={400}
