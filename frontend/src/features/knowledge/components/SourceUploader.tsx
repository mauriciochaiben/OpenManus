...
const SourceUploader: React.FC<SourceUploaderProps> = ({
    ...
    const beforeUpload = (file: RcFile): boolean => {
        ...
        const allowedExtensions = ['.pdf', '.txt', '.mp3', '.wav', '.m4a', '.aac', '.ogg', '.flac', '.webm'];
        ...
        if (!isValidType) {
            message.error({
                content: 'Only PDF, TXT, and Audio files (MP3, WAV, M4A, AAC, OGG, FLAC, WEBM) are allowed!',
        ...
        >
                ...
                >
                    <div style={{ padding: '20px' }}>
                        ...
                        <p className="ant-upload-hint" style={{ color: '#666' }}>
                            Support for PDF, TXT, and Audio files (MP3, WAV, M4A, AAC, OGG, FLAC, WEBM). Maximum file size: {maxFileSize}MB
                        </p>
                    </div>
                </Dragger>
                            ...
                            <div>
                                ...
                                {uploadProgress.status === 'error' && (
                                    <Alert
                                        ...
                                        style={{ padding: '8px 12px' }}
                                        action={
                                            <Button size="small" type="primary" onClick={() => setUploadProgress(null)}>
                                                Try Again
                                            </Button>
                                        }
                                    />
            ...
            <div style={{ marginTop: '16px' }}>
                <Paragraph type="secondary" style={{ fontSize: '12px' }}>
                    ...
                    <br />
                    <br />
                    Files will be processed automatically after upload. Audio files will be transcribed
                    to text and then processed into searchable chunks for the knowledge base.
                </Paragraph>
            </div>
        </Card>
    );
