            ...
            >
                <Space>
                    <Avatar
                        ...
                        icon={<span style={{ fontSize: '16px' }}>{getProviderIcon(provider.type)}</span>}
                    />
                    <div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <Space>
                        <Avatar
                            size={48}
                            style={{ backgroundColor: '#f0f0f0' }}
                            icon={<span style={{ fontSize: '24px' }}>{getProviderIcon(provider.type)}</span>}
                        />
                        <div>
                    ...
                    {selected && (
                        <Badge status="processing" text="Selected" />
                    )}
                </div>
                        ...
                        {provider.baseUrl && (
                            <Tooltip title="Custom Endpoint Available">
                                <Space size="small">
                                    ...
                                    <Text type="secondary" style={{ fontSize: '12px' }}>Custom URL</Text>
                                </Space>
                            </Tooltip>
                        )}
                    </Space>
