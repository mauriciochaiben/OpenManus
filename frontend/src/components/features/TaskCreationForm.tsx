...
const TaskCreationForm: React.FC<TaskCreationFormProps> = ({
  ...
  const complexityOptions = [
    {
      value: 'low',
      label: 'Low - Simple tasks, quick execution',
      icon: <UserOutlined />,
    },
    {
      value: 'medium',
      label: 'Medium - Moderate complexity, may require multiple steps',
      icon: <BulbOutlined />,
    },
    {
      value: 'high',
      label: 'High - Complex tasks, multi-agent coordination',
      icon: <TeamOutlined />,
    },
  ];
  ...
  const modeOptions = [
    {
      value: 'auto',
      label: 'Auto - Let AI decide the best approach',
      icon: <ApiOutlined />,
    },
    {
      value: 'single',
      label: 'Single Agent - Use one specialized agent',
      icon: <UserOutlined />,
    },
    {
      value: 'multi',
      label: 'Multi-Agent - Coordinate multiple agents',
      icon: <TeamOutlined />,
    },
  ];
      ...
      <Card className='task-creation-card'>
        <Space direction='vertical' style={{ width: '100%' }} size='large'>
          ...
          >
            ...
            {complexityAnalysis && (
              <Alert
                message={`Complexity Analysis: ${
                  complexityAnalysis.isComplex ? 'High' : 'Medium'
                } complexity detected`}
            ...
            >
              <Select
                placeholder='Select the expected complexity of your task'
                size='large'
              >
            ...
            <Form.Item label='Execution Mode' name='mode' initialValue='auto'>
          ...
          <DocumentUpload onUploadSuccess={handleUploadSuccess} maxFiles={5} />
