            ...
            if (data.task_id === taskId) {
                setSteps(prev => {
                    ...
                    if (existingIndex >= 0) {
                        ...
                        return [...prev, data.step].sort((a, b) => a.step_number - b.step_number);
                    }
                });
            }
        });
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '16px' }}>
                                ...
                                {execution.completed_at && (
                                    <div>
                                        ...
                                        <Text>{new Date(execution.completed_at).toLocaleString()}</Text>
                                    </div>
                                )}
                            </div>
                        </Space>
                        ...
                        <Timeline>
                            {steps.map((step) => (
                                ...
                                >
                                    <Space direction="vertical" style={{ width: '100%' }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <Text strong>Step {step.step_number}: {step.title}</Text>
                                        ...
                                        {step.output && step.output.trim() && (
                                            <Card size="small" style={{ background: '#f5f5f5', marginTop: '8px' }}>
