...
from app.db.vector_store import get_vector_store, VectorStoreError
...
class SourceService:
    ...
    async def upload_source(self, 
                           ...
                           metadata: Optional[Dict[str, Any]] = None) -> SourceDocument:
        """
    ...
    async def _create_source_record(self,
                                   file: UploadFile,
                                   file_path: str,
                                   content_hash: str,
                                   owner_id: Optional[str] = None,
    ...
    async def _process_source(self, file_path: str, source_id: str) -> None:
        ...
        try:
            ...
            logger.info(f"Processing completed for {source_doc.filename}: "
    ...
    async def _extract_text_content(self, file_path: str, doc_type: Optional[DocumentType]) -> str:
        """
